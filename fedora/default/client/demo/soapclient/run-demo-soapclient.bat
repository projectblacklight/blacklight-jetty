...
if not exist "%FEDORA_HOME%\client\fcrepo-client-admin-3.3.jar" goto clientNotFound
...
echo Client cannot be found at %FEDORA_HOME%\client\fcrepo-client-admin-3.3.jar
goto end
