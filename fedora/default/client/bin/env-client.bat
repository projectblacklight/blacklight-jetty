...
if exist "%FEDORA_HOME%\client\fcrepo-client-admin-3.3.jar" goto clientJarFound
echo ERROR: fcrepo-client-admin-3.3.jar not found in %FEDORA_HOME%\client
exit /B 1
:clientJarFound
...
set CP="%FEDORA_HOME%\client;%FEDORA_HOME%\client\fcrepo-client-admin-3.3.jar"
