...
if exist "%FEDORA_HOME%\client\fcrepo-client-admin-3.4.2.jar" goto clientJarFound
...
set CP="%FEDORA_HOME%\client\bin;%FEDORA_HOME%\client\fcrepo-client-admin-3.4.2.jar"
